...
urlpatterns = [
    ...
    path('card-payment-paystack', views.showPaymentCompleteCard, name='payment_complete_card'),
    ...
    path('qwikvendor-dashboard/credits/', views.showQwikVendorCredits, name='qwikvendor_credits'),
    path('qwika-dashboard/payments/', views.showQwikAdminPayments, name='qwikadmin_payments'),
    path('qwikvendor-dashboard/payments/', views.showQwikVendorPayments, name='qwikvendor_payments'),
    path('qwika-dashboard/sales/', views.showQwikAdminSales, name='qwikadmin_sales'),
    path('qwikvendor-dashboard/sales/', views.showQwikVendorSales, name='qwikvendor_sales'),
