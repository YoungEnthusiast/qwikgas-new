...
urlpatterns = [
    ...
    path('qwikpartner-dashboard/cylinders-delivered-to-qwikcustomer/', views.showQwikPartnerCylindersDeliveredToQwikCustomer, name='qwikpartner_cylinders_delivered_to_qwikcustomer'),
