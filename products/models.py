...
class Category(models.Model):
    type = models.CharField(max_length=20, unique=True, verbose_name="Product Type")
    mass = models.CharField(max_length=6, unique=True, verbose_name="LPG Weight")
    slug = models.SlugField(max_length=200)
    price = models.DecimalField(max_digits=11, null=True, decimal_places=2)
    tare = models.CharField(max_length=6, unique=True, null=True, verbose_name="Tare Weight")
    working = models.CharField(max_length=6, null=True, verbose_name="Working Pressure")
    test = models.CharField(max_length=6, null=True, verbose_name="Test Pressure")
    water = models.CharField(max_length=6, null=True, verbose_name="Water Capacity")
...
class Cylinder(models.Model):
    ...
    who9 = models.CharField(max_length=8, blank=True, null=True)
