...
urlpatterns = [
    ...
    path('qwikvendor-dashboard/sales-graph/', views.showQwikVendorSalesGraph, name='qwikvendor_sales_graph'),
    path('qwika-dashboard/anticipatory-credits/', views.showQwikAdminAntiCredits, name='qwikadmin_anti_credits'),
    path('qwikvendor-dashboard/anticipatory-credits/', views.showQwikVendorAntiCredits, name='qwikvendor_anti_credits'),
    path('qwika-dashboard/anticipatory-payments/', views.showQwikAdminAntiPayments, name='qwikadmin_anti_payments'),
    path('qwikvendor-dashboard/anticipatory-payments/', views.showQwikVendorAntiPayments, name='qwikvendor_anti_payments'),
    path('qwika-dashboard/anticipatory-sales/', views.showQwikAdminAntiSales, name='qwikadmin_anti_sales'),
    path('qwikvendor-dashboard/anticipatory-sales/', views.showQwikVendorAntiSales, name='qwikvendor_anti_sales'),
    ...
    path('qwika-dashboard/anticipatory-sales/export-csv', views.exportCSVSalesAnti, name='export_csv_sales'),
